...
$query = "SELECT nombre, director, genero, ano, duracion, clasificacion, pais, sinopsis, reparto, imagen, trailer FROM peliculas WHERE nombre LIKE 'Kill Bill Vol.1'";
...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td><img src="../../sources/fotos_pelis/KILL_BILL_1.jpg" alt="Imagen de la película" width="150"></td>
    ...
    <div class="video-container">
        <video controls width="640" height="360">
            <source src="../../pelis/BILL_BILL_1.mp4" type="video/mp4">
