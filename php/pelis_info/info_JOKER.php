...
$query = "SELECT nombre, director, genero, ano, duracion, clasificacion, pais, sinopsis, reparto, imagen, trailer FROM peliculas WHERE nombre LIKE 'Joker'";
...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td><img src="../../sources/fotos_pelis/JOKER.jpg" alt="Imagen de la película" width="150"></td>
    ...
    <div class="video-container">
        <video controls width="640" height="360">
            <source src="../../pelis/JOKER.mp4" type="video/mp4">
