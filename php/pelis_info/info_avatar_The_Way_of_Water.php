...
$query = "SELECT nombre, director, genero, ano, duracion, clasificacion, pais, sinopsis, reparto, imagen, trailer FROM peliculas WHERE nombre LIKE 'Avatar: The Way of Water'";
